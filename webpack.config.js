...
var path = require('path'); // Node module for resolving paths
...
Encore
    ...
    .addAliases({
        '@': path.resolve(__dirname, 'assets', 'js'), // JS components shortcut
    ...
    .enableSassLoader()
    // enables Vue.js support (we add version: 3 to enable Vue 3 support, omit it to enable Vue 2 support)
    .enableVueLoader(() => {}, {
        version: 3,
    })
